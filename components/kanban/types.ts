...
export const PRIORITY_CONFIG: Record<Priority, { label: string; className: string; dot?: string }> =
  {
    low: {
      label: "Low",
      className:
        "border-zinc-500/30 dark:border-zinc-500/40 text-zinc-600 dark:text-zinc-400 bg-zinc-100 dark:bg-zinc-800/50",
    },
    medium: {
      label: "Medium",
      className:
        "border-amber-500/30 dark:border-amber-500/40 text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20",
    },
    high: {
      label: "High",
      className:
